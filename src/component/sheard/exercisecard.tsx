...
const Exercisecard = ({ exercise }: { exercise: IExercise }) => {
    return (
        <Link href={`/details/${exercise.id}`}>
            <div className='group w-full max-w-md overflow-hidden rounded-2xl border border-slate-700 bg-[#15171e] shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-amber-300 '>
